...
/*Strat ThaiGerTec 2015 By Ruethaichonnanee Tantiwit*/
...
#define CRO_CONNECT_LEN                                 0x02
#define CRM_CONNECT_NMODE_LEN                           0x08
...
#define CRM_CONNECT_UMODE_LEN                           0x0A
#define USER_MODE                                       0x01

/*-----------------------------BB_ID & BB_SID---------------------------------*/
#define PIC32MX_BB                                      0x01
#define PIC32MX_BB_V2_0_a                               0x00
/*----------------------------IOB_ID & IOB_SID--------------------------------*/
#define POWERO_IO                                       0x01
#define POWERO_IO_V1_1_a                                0x00

#define DIO128_IO                                       0x02

#define DIO16_IO                                        0x03
#define DIO16_IO_V2_0_a                                 0x00

#define TGTFR_IO                                        0x04

#define RELAY_IO                                        0x05
#define RELAY_IO_V1_1_a                                 0x00
...
#define FM14_IO                                         0x08
#define FM14_IO_V1_0_a                                  0x00
/*-----------------------------FW_ID & FW_SID---------------------------------*/
#define FW_UNDEFINE                                     0xFF

#define F_POWERO_IO                                     0x01
#define F_POWERO_IO_V1_0_a                              0x00

#define F_DIO128_IO                                     0x02

#define F_DIO16_IO                                      0x03
#define F_DIO16_IO_V1_0_a                               0x00

#define F_TGTFR_IO                                      0x04

#define F_RELAY_IO                                      0x05
#define F_RELAY_IO_V1_0_a                               0x00

#define F_AI_IO                                         0x06

#define F_AO_IO                                         0x07

#define F_FM14_IO                                       0x08
#define F_FM14_IO_V1_0                                  0x00
/*----------------------------FPGA_ID & FPGA_SID------------------------------*/
#define FPGA_UNDEFINE                                   0xFF

#define FP_POWERO_IO                                    0x01
#define FP_POWERO_IO_Vx_x_a                             0x00

#define FP_DIO128_IO                                    0x02

#define FP_DIO16_IO                                     0x03
#define FP_DIO16_IO_Vx_x_a                              0x00

#define FP_TGTFR_IO                                     0x04

#define FP_RELAY_IO                                     0x05
#define FP_RELAY_IO_Vx_x_a                              0x00

#define FP_AI_IO                                        0x06

#define FP_AO_IO                                        0x07

#define FP_FM14_IO                                      0x08

#define BB_ID                                           PIC32MX_BB
#define BB_SID                                          PIC32MX_BB_V2_0_a
#define IOB_ID                                          FM14_IO
#define IOB_SID                                         FM14_IO_V1_0_a
#define FW_ID                                           F_FM14_IO
#define FW_SID                                          F_FM14_IO_V1_0
#define FPGA_ID                                         FPGA_UNDEFINE
#define FPGA_SID                                        FPGA_UNDEFINE

#define CRM_CONNECT_BB_ID                               CRM_BYTE(1)
#define CRM_CONNECT_BB_SID                              CRM_BYTE(2)
#define CRM_CONNECT_IOB_ID                              CRM_BYTE(3)
#define CRM_CONNECT_IOB_SID                             CRM_BYTE(4)
#define CRM_CONNECT_FW_ID                               CRM_BYTE(5)
#define CRM_CONNECT_FW_SID                              CRM_BYTE(6)
#define CRM_CONNECT_FPGA_ID                             CRM_BYTE(7)
#define CRM_CONNECT_FPGA_SID                            CRM_BYTE(8)
#define CRM_CONNECT_RESOUCE                             CRM_BYTE(9)
...
#define CRO_SHORT_DOWNLOAD_MAX_SIZE                     ((vuint8)((kXcpMaxCTO-8)/kXcpAG)) //fon edit from CRM_SHOPT_DOWNLOAD_MAX_SIZE
...
#define CRM_USER_SERVICE_SIZE                           0x1
/****************************************************************************/
/* Implementation                                                           */
/****************************************************************************/
...
extern void XcpCommand( uint8_t* pCommand );
...
#else
extern void ApplXcpSend( vuint8 len, BYTEPTR msg );
#endif
...
/*Start ThaiGerTec 2015. By Ruethaichonnanee Tantiwit*/
...
extern vuint8 ApplXcpUserService( MEMORY_ROM BYTEPTR pCmd, BYTEPTR pRes);
/*End ThaiGerTec 2015*/
#endif
