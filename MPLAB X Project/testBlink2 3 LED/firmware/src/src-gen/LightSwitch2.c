...
static sc_boolean lightSwitch2_check_Copy_1_LED2_off_tr0_tr0(const LightSwitch2* handle);
static sc_boolean lightSwitch2_check_Copy_1_LED2_on_tr0_tr0(const LightSwitch2* handle);
...
static void lightSwitch2_effect_Copy_1_LED2_off_tr0(LightSwitch2* handle);
static void lightSwitch2_effect_Copy_1_LED2_on_tr0(LightSwitch2* handle);
...
static void lightSwitch2_enact_Copy_1_LED2_off(LightSwitch2* handle);
static void lightSwitch2_enact_Copy_1_LED2_on(LightSwitch2* handle);
...
static void lightSwitch2_exact_Copy_1_LED2_off(LightSwitch2* handle);
static void lightSwitch2_exact_Copy_1_LED2_on(LightSwitch2* handle);
...
static void lightSwitch2_enseq_Copy_1_LED2_off_default(LightSwitch2* handle);
static void lightSwitch2_enseq_Copy_1_LED2_on_default(LightSwitch2* handle);
...
static void lightSwitch2_enseq_Copy_1_LED2_default(LightSwitch2* handle);
...
static void lightSwitch2_exseq_Copy_1_LED2_off(LightSwitch2* handle);
static void lightSwitch2_exseq_Copy_1_LED2_on(LightSwitch2* handle);
static void lightSwitch2_exseq_LED1(LightSwitch2* handle);
static void lightSwitch2_exseq_LED2(LightSwitch2* handle);
static void lightSwitch2_exseq_Copy_1_LED2(LightSwitch2* handle);
...
static void lightSwitch2_react_Copy_1_LED2_off(LightSwitch2* handle);
static void lightSwitch2_react_Copy_1_LED2_on(LightSwitch2* handle);
...
static void lightSwitch2_react_Copy_1_LED2__entry_Default(LightSwitch2* handle);
...
void lightSwitch2_enter(LightSwitch2* handle)
{
	...
	lightSwitch2_enseq_Copy_1_LED2_default(handle);
}
...
void lightSwitch2_exit(LightSwitch2* handle)
{
	...
	lightSwitch2_exseq_Copy_1_LED2(handle);
}

sc_boolean lightSwitch2_isActive(const LightSwitch2* handle)
{
	sc_boolean result;
	if (handle->stateConfVector[0] != LightSwitch2_last_state || handle->stateConfVector[1] != LightSwitch2_last_state || handle->stateConfVector[2] != LightSwitch2_last_state)
	{
		result =  bool_true;
	}
	else
...
static void lightSwitch2_clearInEvents(LightSwitch2* handle)
{
	...
	handle->timeEvents.lightSwitch2_Copy_1_LED2_off_tev0_raised = bool_false;
	handle->timeEvents.lightSwitch2_Copy_1_LED2_on_tev0_raised = bool_false;
}
...
void lightSwitch2_runCycle(LightSwitch2* handle)
{
	...
	for (handle->stateConfVectorPosition = 0;
		...
		case LightSwitch2_Copy_1_LED2_off :
		{
			lightSwitch2_react_Copy_1_LED2_off(handle);
			break;
		}
		case LightSwitch2_Copy_1_LED2_on :
		{
			lightSwitch2_react_Copy_1_LED2_on(handle);
			break;
		}
		default:
			break;
...
sc_boolean lightSwitch2_isStateActive(const LightSwitch2* handle, LightSwitch2States state)
{
	...
	switch (state)
	{
		...
		case LightSwitch2_LED2_on :
			...
			break;
		case LightSwitch2_Copy_1_LED2_off :
			result = (sc_boolean) (handle->stateConfVector[2] == LightSwitch2_Copy_1_LED2_off
			);
			break;
		case LightSwitch2_Copy_1_LED2_on :
			result = (sc_boolean) (handle->stateConfVector[2] == LightSwitch2_Copy_1_LED2_on
			);
			break;
		default:
			result = bool_false;
...
static sc_boolean lightSwitch2_check_Copy_1_LED2_off_tr0_tr0(const LightSwitch2* handle)
{
	return handle->timeEvents.lightSwitch2_Copy_1_LED2_off_tev0_raised;
}

static sc_boolean lightSwitch2_check_Copy_1_LED2_on_tr0_tr0(const LightSwitch2* handle)
{
	return handle->timeEvents.lightSwitch2_Copy_1_LED2_on_tev0_raised;
}
...
static void lightSwitch2_effect_Copy_1_LED2_off_tr0(LightSwitch2* handle)
{
	lightSwitch2_exseq_Copy_1_LED2_off(handle);
	lightSwitch2Iface_setLight(handle, bool_true, 3);
	lightSwitch2_enseq_Copy_1_LED2_on_default(handle);
}

static void lightSwitch2_effect_Copy_1_LED2_on_tr0(LightSwitch2* handle)
{
	lightSwitch2_exseq_Copy_1_LED2_on(handle);
	lightSwitch2Iface_setLight(handle, bool_false, 3);
	lightSwitch2_enseq_Copy_1_LED2_off_default(handle);
}
...
{
	/* Entry action for state 'off'. */
	lightSwitch2_setTimer(handle, (sc_eventid) &(handle->timeEvents.lightSwitch2_Copy_1_LED2_off_tev0_raised) , 500, bool_false);
}
...
{
	/* Entry action for state 'on'. */
	lightSwitch2_setTimer(handle, (sc_eventid) &(handle->timeEvents.lightSwitch2_Copy_1_LED2_on_tev0_raised) , 500, bool_false);
}
...
{
	/* Exit action for state 'off'. */
	lightSwitch2_unsetTimer(handle, (sc_eventid) &(handle->timeEvents.lightSwitch2_Copy_1_LED2_off_tev0_raised) );		
}
...
{
	/* Exit action for state 'on'. */
	lightSwitch2_unsetTimer(handle, (sc_eventid) &(handle->timeEvents.lightSwitch2_Copy_1_LED2_on_tev0_raised) );		
}
...
{
	/* 'default' enter sequence for state off */
	lightSwitch2_enact_Copy_1_LED2_off(handle);
	handle->stateConfVector[2] = LightSwitch2_Copy_1_LED2_off;
...
{
	/* 'default' enter sequence for state on */
	lightSwitch2_enact_Copy_1_LED2_on(handle);
	handle->stateConfVector[2] = LightSwitch2_Copy_1_LED2_on;
	handle->stateConfVectorPosition = 2;
}
...
/* 'default' enter sequence for region Copy_1_LED2 */
static void lightSwitch2_enseq_Copy_1_LED2_default(LightSwitch2* handle)
{
	/* 'default' enter sequence for region Copy_1_LED2 */
	lightSwitch2_react_Copy_1_LED2__entry_Default(handle);
}
...
{
	/* Default exit sequence for state off */
	handle->stateConfVector[2] = LightSwitch2_last_state;
	handle->stateConfVectorPosition = 2;
	lightSwitch2_exact_Copy_1_LED2_off(handle);
}
...
static void lightSwitch2_exseq_Copy_1_LED2_on(LightSwitch2* handle)
{
	...
	handle->stateConfVector[2] = LightSwitch2_last_state;
	handle->stateConfVectorPosition = 2;
	lightSwitch2_exact_Copy_1_LED2_on(handle);
}
...
/* Default exit sequence for region Copy_1_LED2 */
static void lightSwitch2_exseq_Copy_1_LED2(LightSwitch2* handle)
{
	/* Default exit sequence for region Copy_1_LED2 */
	/* Handle exit of all possible states (of LightSwitch2.Copy_1_LED2) at position 2... */
...
{
	/* The reactions of state off. */
	if (lightSwitch2_check_Copy_1_LED2_off_tr0_tr0(handle) == bool_true)
	{ 
		lightSwitch2_effect_Copy_1_LED2_off_tr0(handle);
	} 
}
...
{
	/* The reactions of state on. */
	if (lightSwitch2_check_Copy_1_LED2_on_tr0_tr0(handle) == bool_true)
	{ 
		lightSwitch2_effect_Copy_1_LED2_on_tr0(handle);
	} 
}
