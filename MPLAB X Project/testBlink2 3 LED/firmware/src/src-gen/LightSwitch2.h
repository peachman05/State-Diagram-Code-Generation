...
typedef enum
{
	LightSwitch2_LED1_off,
	LightSwitch2_LED1_on,
	LightSwitch2_LED2_off,
	LightSwitch2_LED2_on,
	LightSwitch2_Copy_1_LED2_off,
	LightSwitch2_Copy_1_LED2_on,
...
typedef struct
{
	sc_boolean lightSwitch2_LED1_off_tev0_raised;
	sc_boolean lightSwitch2_LED1_on_tev0_raised;
	sc_boolean lightSwitch2_LED2_off_tev0_raised;
	sc_boolean lightSwitch2_LED2_on_tev0_raised;
	sc_boolean lightSwitch2_Copy_1_LED2_off_tev0_raised;
	sc_boolean lightSwitch2_Copy_1_LED2_on_tev0_raised;
} LightSwitch2TimeEvents;


/*! Define dimension of the state configuration vector for orthogonal states. */
#define LIGHTSWITCH2_MAX_ORTHOGONAL_STATES 3
